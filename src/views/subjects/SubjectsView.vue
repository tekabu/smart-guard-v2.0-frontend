...
const applyFilters = async () => {
  try {
    ...
    if (activeFilter.value !== null) {
      filteredData = filteredData.filter(subject => subject.active === activeFilter.value);
    }
    
    subjects.value = filteredData;
  } catch (err) {
...
async function deleteSubject() {
  try {
    await subjectsService.delete(subjectToDelete.value.id);
    
    // Remove subject from local list
...
<template>
  <!-- Hero -->
  <BasePageHeading title="Subjects" subtitle="Manage academic subjects.">
    <template #extra>
      <button 
  ...
  <div class="content">
    ...
    <BaseBlock title="Subject List" content-full>
      <!-- Loading state -->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p v-if="subjectToDelete">
            Are you sure you want to delete subject
            <strong>{{ subjectToDelete.subject }}</strong>?
          </p>
