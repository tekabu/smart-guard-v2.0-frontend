...
<template>
    ...
    <template #extra>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item" aria-current="page">Button Groups</li>
        </ol>
      </nav>
    </template>
  </BasePageHeading>
  ...
  <div class="content">
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Primary"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Secondary"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Info"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Success"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Warning"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Danger"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Dark"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Outline Light"
            >
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Primary"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Secondary"
            >
              <button type="button" class="btn btn-alt-secondary">Left</button>
              <button type="button" class="btn btn-alt-secondary">
                Middle
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Info"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Success"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Warning"
            >
          ...
          <div class="mb-3">
            <div
              class="btn-group"
              role="group"
              aria-label="Horizontal Alternate Danger"
            >
    ...
    <!-- Sizes -->
    <BaseBlock title="Sizes">
      <p class="fs-sm text-muted">
        You can easily have a small or large size for all button group
        variations
      </p>
      <div class="row items-push">
        <div class="col-sm-6 col-xl-4">
          ...
          <div class="mb-3">
            <div
              ...
              role="group"
              aria-label="Large Horizontal Primary"
            >
              <button type="button" class="btn btn-primary">Left</button>
              <button type="button" class="btn btn-primary">Middle</button>
              <button type="button" class="btn btn-primary">Right</button>
          ...
          <div class="mb-3">
            <div
              ...
              role="group"
              aria-label="Small Vertical Primary"
            >
              <button type="button" class="btn btn-primary">Left</button>
              <button type="button" class="btn btn-primary">Middle</button>
              <button type="button" class="btn btn-primary">Right</button>
          ...
          <div class="mb-3">
            <div
              ...
              role="group"
              aria-label="Large Vertical Primary"
            >
              <button type="button" class="btn btn-primary">Left</button>
              <button type="button" class="btn btn-primary">Middle</button>
              <button type="button" class="btn btn-primary">Right</button>
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div class="mb-3">
            <div
              class="btn-group btn-group-lg"
              role="group"
              aria-label="Large Outline Primary"
            >
              <button type="button" class="btn btn-outline-secondary">
                Left
              </button>
          ...
          <div class="mb-3">
            <div
              class="btn-group-vertical btn-group-sm"
              role="group"
              aria-label="Small Outline Vertical Primary"
            >
              <button type="button" class="btn btn-outline-secondary">
                Left
              </button>
          ...
          <div class="mb-3">
            <div
              class="btn-group-vertical btn-group-lg"
              role="group"
              aria-label="Large Outline Vertical Primary"
            >
              <button type="button" class="btn btn-outline-secondary">
                Left
              </button>
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div class="mb-3">
            <div
              class="btn-group btn-group-sm"
              role="group"
              aria-label="Small Alternate Secondary"
            >
              <button type="button" class="btn btn-alt-secondary">Left</button>
              <button type="button" class="btn btn-alt-secondary">
                Middle
          ...
          <div class="mb-3">
            <div
              class="btn-group btn-group-lg"
              role="group"
              aria-label="Large Alternate Secondary"
            >
              <button type="button" class="btn btn-alt-secondary">Left</button>
              <button type="button" class="btn btn-alt-secondary">
                Middle
          ...
          <div class="mb-3">
            <div
              class="btn-group-vertical btn-group-sm"
              role="group"
              aria-label="Small Alternate Vertical Secondary"
            >
              <button type="button" class="btn btn-alt-secondary">Left</button>
              <button type="button" class="btn btn-alt-secondary">
                Middle
          ...
          <div class="mb-3">
            <div
              class="btn-group-vertical btn-group-lg"
              role="group"
              aria-label="Large Alternate Vertical Secondary"
            >
              <button type="button" class="btn btn-alt-secondary">Left</button>
              <button type="button" class="btn btn-alt-secondary">
                Middle
    ...
    <BaseBlock title="Vertical">
      ...
      <div class="row">
        <div class="col-sm-6 col-xl-4">
          <!-- Default Style -->
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Primary"
          >
            <button type="button" class="btn btn-primary">Left</button>
            <button type="button" class="btn btn-primary">Middle</button>
            <button type="button" class="btn btn-primary">Right</button>
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Primary"
          >
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Secondary"
          >
            <button type="button" class="btn btn-outline-secondary">
              Left
            </button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Info"
          >
            <button type="button" class="btn btn-outline-info">Left</button>
            <button type="button" class="btn btn-outline-info">Middle</button>
            <button type="button" class="btn btn-outline-info">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Success"
          >
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Warning"
          >
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Danger"
          >
            <button type="button" class="btn btn-outline-danger">Left</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Dark"
          >
            <button type="button" class="btn btn-outline-dark">Left</button>
            <button type="button" class="btn btn-outline-dark">Middle</button>
            <button type="button" class="btn btn-outline-dark">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Outline Light"
          >
            <button type="button" class="btn btn-outline-light">Left</button>
        ...
        <div class="col-sm-6 col-xl-4">
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Primary"
          >
            <button type="button" class="btn btn-alt-primary">Left</button>
            <button type="button" class="btn btn-alt-primary">Middle</button>
            <button type="button" class="btn btn-alt-primary">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Secondary"
          >
            <button type="button" class="btn btn-alt-secondary">Left</button>
            <button type="button" class="btn btn-alt-secondary">Middle</button>
            <button type="button" class="btn btn-alt-secondary">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Info"
          >
            <button type="button" class="btn btn-alt-info">Left</button>
            <button type="button" class="btn btn-alt-info">Middle</button>
            <button type="button" class="btn btn-alt-info">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Success"
          >
            <button type="button" class="btn btn-alt-success">Left</button>
            <button type="button" class="btn btn-alt-success">Middle</button>
            <button type="button" class="btn btn-alt-success">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Warning"
          >
            <button type="button" class="btn btn-alt-warning">Left</button>
            <button type="button" class="btn btn-alt-warning">Middle</button>
            <button type="button" class="btn btn-alt-warning">Right</button>
          ...
          <div
            class="btn-group-vertical push me-3"
            role="group"
            aria-label="Vertical Alternate Danger"
          >
            <button type="button" class="btn btn-alt-danger">Left</button>
            <button type="button" class="btn btn-alt-danger">Middle</button>
            <button type="button" class="btn btn-alt-danger">Right</button>
      ...
      <div class="row items-push">
        <div class="col-md-6 col-xl-4">
          ...
          >
            <div
              ...
              role="group"
              aria-label="Primary First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Primary Second group"
            >
            ...
            <div
              ...
              role="group"
              aria-label="Primary Third group"
            >
          ...
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Secondary First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Secondary Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Secondary Third group"
            >
          ...
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Success First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Success Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Success Third group"
            >
          ...
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Warning First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Warning Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Warning Third group"
            >
          ...
          >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Danger Second group"
            >
        ...
        <div class="col-md-6 col-xl-4">
          ...
          >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Primary Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Primary Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Secondary Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Secondary First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Secondary Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Secondary Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Info Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Info First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Info Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Info Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Success Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Success First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Success Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Success Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Warning Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Warning First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Warning Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Warning Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Danger Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Danger First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Danger Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Danger Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Dark Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Dark First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Dark Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Dark Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Outline Light Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Light First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Outline Light Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Outline Light Third group"
            >
        ...
        <div class="col-md-6 col-xl-4">
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Primary Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Primary First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Primary Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Primary Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Secondary Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Secondary First group"
            >
              <button type="button" class="btn btn-alt-secondary">1</button>
              <button type="button" class="btn btn-alt-secondary">2</button>
              <button type="button" class="btn btn-alt-secondary">3</button>
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Secondary Second group"
            >
              <button type="button" class="btn btn-alt-secondary">5</button>
              <button type="button" class="btn btn-alt-secondary">6</button>
              <button type="button" class="btn btn-alt-secondary">7</button>
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Secondary Third group"
            >
              <button type="button" class="btn btn-alt-secondary">8</button>
            </div>
          </div>
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Info Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Info First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Info Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Info Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Success Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Success First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Success Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Success Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Warning Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Warning First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Warning Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Warning Third group"
            >
          ...
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Alternate Danger Toolbar with button groups"
          >
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Danger First group"
            >
            ...
            <div
              class="btn-group me-2 mb-2"
              role="group"
              aria-label="Alternate Danger Second group"
            >
            ...
            <div
              class="btn-group mb-2"
              role="group"
              aria-label="Alternate Danger Third group"
            >
      ...
      <div class="row items-push">
        <div class="col-lg-6">
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Small Primary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Primary First group"
            >
              <button type="button" class="btn btn-primary">1</button>
              <button type="button" class="btn btn-primary">2</button>
              <button type="button" class="btn btn-primary">3</button>
            ...
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Primary Second group"
            >
              <button type="button" class="btn btn-primary">5</button>
              <button type="button" class="btn btn-primary">6</button>
              <button type="button" class="btn btn-primary">7</button>
            ...
            <div
              ...
              role="group"
              aria-label="Small Primary Third group"
            >
              <button type="button" class="btn btn-primary">8</button>
            </div>
          </div>
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Small Outline Secondary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Outline Secondary First group"
            >
              <button type="button" class="btn btn-outline-secondary">1</button>
              <button type="button" class="btn btn-outline-secondary">2</button>
              <button type="button" class="btn btn-outline-secondary">3</button>
            ...
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Outline Secondary Second group"
            >
              <button type="button" class="btn btn-outline-secondary">5</button>
              <button type="button" class="btn btn-outline-secondary">6</button>
              <button type="button" class="btn btn-outline-secondary">7</button>
            ...
            <div
              class="btn-group btn-group-sm mb-2"
              role="group"
              aria-label="Small Outline Secondary Third group"
            >
              <button type="button" class="btn btn-outline-secondary">8</button>
            </div>
          </div>
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Small Alternate Primary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Alternate Primary First group"
            >
              <button type="button" class="btn btn-alt-primary">1</button>
              <button type="button" class="btn btn-alt-primary">2</button>
              <button type="button" class="btn btn-alt-primary">3</button>
            ...
            <div
              class="btn-group btn-group-sm me-2 mb-2"
              role="group"
              aria-label="Small Alternate Primary Second group"
            >
              <button type="button" class="btn btn-alt-primary">5</button>
              <button type="button" class="btn btn-alt-primary">6</button>
              <button type="button" class="btn btn-alt-primary">7</button>
            ...
            <div
              class="btn-group btn-group-sm mb-2"
              role="group"
              aria-label="Small Alternate Primary Third group"
            >
              <button type="button" class="btn btn-alt-primary">8</button>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Large Primary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Small Primary First group"
            >
              <button type="button" class="btn btn-primary">1</button>
            ...
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Large Primary Second group"
            >
              <button type="button" class="btn btn-primary">5</button>
              <button type="button" class="btn btn-primary">6</button>
              <button type="button" class="btn btn-primary">7</button>
            ...
            <div
              class="btn-group btn-group-lg mb-2"
              role="group"
              aria-label="Large Primary Third group"
            >
              <button type="button" class="btn btn-primary">8</button>
            </div>
          </div>
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Large Outline Secondary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Large Outline Secondary First group"
            >
              <button type="button" class="btn btn-outline-secondary">1</button>
              <button type="button" class="btn btn-outline-secondary">2</button>
              <button type="button" class="btn btn-outline-secondary">3</button>
            ...
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Large Outline Secondary Second group"
            >
              <button type="button" class="btn btn-outline-secondary">5</button>
              <button type="button" class="btn btn-outline-secondary">6</button>
              <button type="button" class="btn btn-outline-secondary">7</button>
            ...
            <div
              class="btn-group btn-group-lg mb-2"
              role="group"
              aria-label="Large Outline Secondary Third group"
            >
              <button type="button" class="btn btn-outline-secondary">8</button>
            </div>
          </div>
          <div
            class="btn-toolbar mb-2"
            role="toolbar"
            aria-label="Large Alternate Primary Toolbar with button groups"
          >
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Large Alternate Primary First group"
            >
              <button type="button" class="btn btn-alt-primary">1</button>
              <button type="button" class="btn btn-alt-primary">2</button>
              <button type="button" class="btn btn-alt-primary">3</button>
            ...
            <div
              class="btn-group btn-group-lg me-2 mb-2"
              role="group"
              aria-label="Large Alternate Primary Second group"
            >
              <button type="button" class="btn btn-alt-primary">5</button>
              <button type="button" class="btn btn-alt-primary">6</button>
              <button type="button" class="btn btn-alt-primary">7</button>
            ...
            <div
              class="btn-group btn-group-lg mb-2"
              role="group"
              aria-label="Large Alternate Primary Third group"
            >
              <button type="button" class="btn btn-alt-primary">8</button>
            </div>
          </div>
    ...
    <!-- Icons -->
    <BaseBlock title="Icons" content-full>
      <p class="fs-sm text-muted">
      ...
      <div
        class="btn-toolbar mb-2"
        role="toolbar"
        aria-label="Icons Toolbar with button groups"
      >
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons File group"
        >
        ...
        <div
          class="btn-group mb-2"
          role="group"
          aria-label="Icons Archive group"
        >
          <button type="button" class="btn btn-primary">
      ...
      >
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Outline File group"
        >
          <button type="button" class="btn btn-outline-secondary">
            <i class="fa fa-fw fa-file"></i>
          </button>
        ...
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Outline Align group"
        >
          <button type="button" class="btn btn-outline-secondary">
            <i class="fa fa-fw fa-align-left"></i>
          </button>
        ...
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Outline List group"
        >
          <button type="button" class="btn btn-outline-secondary">
            <i class="fa fa-fw fa-list-ul"></i>
          </button>
        ...
        <div
          class="btn-group mb-2"
          role="group"
          aria-label="Icons Outline Archive group"
        >
          <button type="button" class="btn btn-outline-secondary">
            <i class="fa fa-fw fa-archive"></i>
          </button>
      ...
      >
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Alternate File group"
        >
        ...
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Alternate Text group"
        >
          <button type="button" class="btn btn-alt-primary">
            <i class="fa fa-fw fa-bold"></i>
          </button>
        ...
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Alternate Align group"
        >
          <button type="button" class="btn btn-alt-primary">
            <i class="fa fa-fw fa-align-left"></i>
          </button>
        ...
        <div
          class="btn-group me-2 mb-2"
          role="group"
          aria-label="Icons Alternate List group"
        >
          <button type="button" class="btn btn-alt-primary">
            <i class="fa fa-fw fa-list-ul"></i>
          </button>
        ...
        <div
          class="btn-group mb-2"
          role="group"
          aria-label="Icons Alternate Archive group"
        >
          <button type="button" class="btn btn-alt-primary">
            <i class="fa fa-fw fa-archive"></i>
          </button>
