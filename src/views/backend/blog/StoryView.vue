      ...
      <div class="text-center fs-sm push">
        <span class="d-inline-block py-2 px-4 bg-body fw-medium rounded">
          <RouterLink
            ...
            >John Doe</RouterLink
          >
          on July 16, 2024 &bull; <span>5 min</span>
        </span>
      </div>
        ...
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Jeffrey Shaw</span> on July 2, 2024 ·
              <span>12 min</span>
            </div>
          </template>
        </BaseBlock>
      ...
      <div class="col-md-4">
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Jack Greene</span> on July 6, 2024 ·
              <span>15 min</span>
            </div>
          </template>
        </BaseBlock>
      ...
      <div class="col-md-4">
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Laura Carr</span> on June 29, 2024 ·
              <span>10 min</span>
            </div>
          </template>
        </BaseBlock>
      ...
      <div class="col-md-4">
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Carol White</span> on June 16, 2024 ·
              <span>13 min</span>
            </div>
          </template>
        </BaseBlock>
      ...
      <div class="col-md-4">
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Lori Grant</span> on May 23, 2024 ·
              <span>10 min</span>
            </div>
          </template>
        </BaseBlock>
      ...
      <div class="col-md-4">
        <BaseBlock tag="a" link-pop class="overflow-hidden">
          <template #content>
            ...
            <div class="block-content block-content-full fs-sm fw-medium">
              <span class="text-primary">Lisa Jenkins</span> on May 15, 2024 ·
              <span>7 min</span>
            </div>
          </template>
        </BaseBlock>
