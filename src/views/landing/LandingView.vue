        ...
        <div class="row g-0 justify-content-center text-center">
          <div class="col-md-10 pt-7 pb-9">
            ...
            >
              ...
              <span>Laravel 11 (with Vite) version is here!</span>
            </div>
            ...
            <p class="fs-5 fw-medium text-muted mb-4 mx-xl-8">
              ...
              <span class="text-body-color fw-semibold">dark mode</span>.
            </p>
            <RouterLink
      ...
      <div class="content content-full">
        ...
        <div class="row py-5">
          ...
          <div class="col-6 col-md-3">
            ...
            <p class="text-muted">
              A brand new Laravel 11 with Vite integration version is now
              included.
            </p>
          </div>
          <div class="col-6 col-md-3">
      ...
      <div class="content content-full">
        <div class="py-5 py-md-8 text-center">
          ...
          <p class="fs-lg fw-medium text-muted mb-4">
            Passionate web design and development with over 18,000 customers
            worldwide.
          </p>
          <a
